...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Toggle light"
  #define USER_GCODE_1 "M118 A1 action:light"

  #define USER_DESC_2 "Shutdown Octoprint"
  #define USER_GCODE_2 "M118 A1 action:shutdown"
